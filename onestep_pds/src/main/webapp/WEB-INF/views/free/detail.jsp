            ...
            <div class="card-body">
                ...
                <form class="comment-form insert-form" action="commentregist" method="post">
                    ...
                    <div class="row border py-2">
                        ...
                        <textarea class="reply-form-textarea form-control" name="commentcontent" required="required" rows="3">내용을 입력하세요.</textarea>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <button type="button" class="btn btn-outline-secondary" onclick="goToMainPage()">메인으로</button>
                        </div>
